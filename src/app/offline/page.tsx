    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-background text-foreground">
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 border border-border bg-card text-foreground px-6 py-3 rounded-lg font-semibold hover:bg-muted transition-colors"
          >
            Go home
          </Link>
        </div>
