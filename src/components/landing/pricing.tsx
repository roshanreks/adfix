            ...
            <FadeIn key={plan.id} delay={plan.popular ? 0.1 : 0}>
              ...
              >
                <div className="relative p-4 sm:p-8">
                  ...
                  <div>
                    <h3 className="text-[18px] sm:text-[20px] font-medium leading-[1.4] text-foreground">{plan.name}</h3>
                    <p className="mt-1 text-[13px] sm:text-[14px] leading-[1.5] text-muted-foreground">{plan.description}</p>
                  </div>

                  <div className="mt-4 sm:mt-6 flex items-baseline gap-1">
                    <span className="text-[32px] sm:text-[40px] font-semibold text-foreground">₹{plan.price}</span>
